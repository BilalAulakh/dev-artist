...
export const metadata = {
    title: 'Services | DEV ARTIST',
    description: 'Web development, mobile apps, and AI solutions.',
};
            ...
            <div className="container services-section">
                ...
                <div className="service-category">
                    <div className="service-content">
                        ...
                        <Link href="/contact" className="cta-btn">Request Quote</Link>
                    </div>
                ...
                <div className="service-category">
                    <div className="service-content">
                        ...
                        <Link href="/contact" className="cta-btn">Let's Build an App</Link>
                    </div>
                ...
                <div className="service-category">
                    <div className="service-content">
                        ...
                        <Link href="/contact" className="cta-btn">Automate Your Business</Link>
                    </div>
